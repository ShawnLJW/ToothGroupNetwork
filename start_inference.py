...
parser.add_argument('--input_dir_path', default="data_obj_parent_directory", type=str, help = "input directory path that contain obj files.")
...
pred_obj = ScanSegmentation(make_inference_pipeline(args.model_name, [args.checkpoint_path, args.checkpoint_path_bdl]))
